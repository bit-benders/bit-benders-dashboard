...
ONCHAIN_ISSUER_DID=did:polygonid:polygon:mumbai:2qCU58EJgrELVqPM6r2LAunTZns6c11DCV2heW2ke

ONCHAIN_ISSUER_CONTRACT_ADDRESS=0x1ad1D9c1398C508D000EDbE0561461ce8fA37c96
URL_MUMBAI_NODE=$URL_MUMBAI_NODE
URL_POLYGON_NODE=$URL_POLYGON_NODE
ONCHAIN_CONTRACT_OWNER=$PRIVATE_KEY
...
trap "kill -9 $SERVER_PID $ISSUER_PID; exit" SIGINT
